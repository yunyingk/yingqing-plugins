...
description: Use when a request needs current web information, source-backed research, fact checking, release notes, prices, schedules, or other knowledge that may have changed recently.
---
